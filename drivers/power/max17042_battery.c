...
static void max17042_reset_vfsoc0_qh0_regs(struct max17042_chip *chip)
{
	...
	data = max17042_read_reg(chip->client, MAX17042_VFSOC);
	max17042_write_reg(chip->client, MAX17042_VFSOC0Enable, VFSOC0_UNLOCK);
	max17042_write_verify_reg(chip->client, MAX17042_VFSOC0, data);
	max17042_write_reg(chip->client, MAX17042_VFSOC0Enable, VFSOC0_LOCK);

	data = max17042_read_reg(chip->client, MAX17042_QH);
	max17042_write_reg(chip->client, MAX17042_QH0, data);
}
